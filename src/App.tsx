...
const App: React.FC = () => {
  ...
  const WHATSAPP_PHONE = '255650654600';
  const WHATSAPP_MESSAGE = encodeURIComponent('Hello! I saw your Atikwanduka Digital Solutions website and would like to know more about your services.');
  const waHref = `https://wa.me/${WHATSAPP_PHONE}?text=${WHATSAPP_MESSAGE}`;
          ...
          <div className="bg-slate-50 p-8 rounded-2xl shadow-sm border border-slate-100">
            <form className="space-y-6 text-left">
              ...
              <div>
                ...
                <textarea className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all h-32" placeholder="I need a website..." />
              </div>
